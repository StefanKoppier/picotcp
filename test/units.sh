...
ASAN_OPTIONS="detect_leaks=0" ./build/test/modunit_geonetworking_guc.elf || exit 1
ASAN_OPTIONS="detect_leaks=0" ./build/test/modunit_geonetworking_management.elf || exit 1
